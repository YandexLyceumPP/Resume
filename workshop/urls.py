...
urlpatterns = [
    ...
    # Field
    path(
        "field/<int:pk>/update/", views.FieldUpdateView.as_view(), name="field_update"
    ),
    path(
        "field/<int:pk>/delete/", views.FieldDeleteView.as_view(), name="field_delete"
    ),
    # Contact
    path(
    ...
    # Block
    path(
        "resume/<int:resume_id>/block/create/",
        views.BlockCreateView.as_view(),
        name="block_create",
    ),
    path(
        "resume/<int:resume_id>/block/<int:pk>/update/",
        views.BlockUpdateView.as_view(),
        name="block_update",
    ),
    path(
        "block/<int:pk>/delete/", views.BlockDeleteView.as_view(), name="block_delete"
    ),
    path(
        "block/<int:pk>/block_changing_order/<str:direction>/",
        views.block_changing_order,
